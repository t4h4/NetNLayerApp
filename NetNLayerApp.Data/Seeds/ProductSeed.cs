...
namespace NetNLayerApp.Data.Seeds
{
    ...
    {
        //_ids ile category id'lere ulasacagiz
        ...
        {
            builder.HasData(
                new Product { Id = 1, Name = "Pilot Kalem", Price = 12.50m, Stock = 100, CategoryId = _ids[0] }, //decimal m, _ids[0] yukaridan gelen id'lerden sifirincisi
